...
public class ServerControlFragment extends Fragment implements MainActivity.IBackPressedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.fragment_server_control, container, false);
