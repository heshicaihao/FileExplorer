...
package com.heshicaihao.fileexplorer.fragment;
...
import com.heshicaihao.fileexplorer.widget.CategoryBar;
import com.heshicaihao.fileexplorer.db.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.heshicaihao.fileexplorer.db.FavoriteList;
import com.heshicaihao.fileexplorer.helper.FileCategoryHelper;
import com.heshicaihao.fileexplorer.helper.FileCategoryHelper.CategoryInfo;
import com.heshicaihao.fileexplorer.helper.FileCategoryHelper.FileCategory;
...
import com.heshicaihao.fileexplorer.utils.Util.SDCardInfo;
...
public class FileCategoryFragment extends Fragment implements IFileInteractionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFileViewFragment = (FileViewFragment) ((MainActivity) mActivity)
                .getFragment(Util.SDCARD_TAB_INDEX);
        mRootView = inflater.inflate(R.layout.fragment_file_explorer_category, container, false);
