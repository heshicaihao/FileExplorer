...
package com.heshicaihao.fileexplorer.db;
...
import com.heshicaihao.fileexplorer.helper.FileListItem.ModeCallback;
import com.heshicaihao.fileexplorer.helper.FileOperationHelper;
import com.heshicaihao.fileexplorer.helper.FileOperationHelper.IOperationProgressListener;
...
import com.heshicaihao.fileexplorer.widget.InformationDialog;
import com.heshicaihao.fileexplorer.widget.TextInputDialog;
import com.heshicaihao.fileexplorer.widget.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    public void onOperationSelectAll() {
        ...
        if (mode == null) {
            mode = mainActivity.startActionMode(new ModeCallback(mContext, this));
